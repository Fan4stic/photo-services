    ...
    <div className="modal-column-left-main-info">
      ...
      <div className="modal-column-left-info-lower">
        ...
        <div className="modal-column-left-info-lower-user">
          ...
          <div className="modal-column-left-info-lower-user-stats">
            ...
            <div className="modal-column-left-info-lower-user-stats-icons">
              <div className="modal-column-left-info-lower-user-stats-icons-friends">
                <svg className="friends-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" >
        ...
        <div className="modal-column-left-info-lower-share-report">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" className={props.reportActive ? "report-icon-active" : "report-icon"} onClick={() => props.toggleReportActive()}>
        ...
        <div className="modal-column-left-info-lower-helpful-nothelpful">
          <div className={props.helpfulActive ? "modal-column-left-info-lower-helpful-nothelpful-isHelpful-active" : "modal-column-left-info-lower-helpful-nothelpful-isHelpful"} onClick={() => props.toggleHelpfulActive()}>
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" class="icon_svg">
              <path d="M15 10L9 3l-6 7h4v5h4v-5h4z"/>
            </svg>
            Helpful
          </div>
          <div className={props.notHelpfulActive ? "modal-column-left-info-lower-helpful-nothelpful-isNotHelpful-active" : "modal-column-left-info-lower-helpful-nothelpful-isNotHelpful"} onClick={() => props.toggleNotHelpfulActive()}>
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" class="icon_svg">
